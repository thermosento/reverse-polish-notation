...
//   and cannot be used.  In this case, the caller of `DQIterator_Remove`
//   is recommended to free the now-invalid iterator.
// - if the deleted node had a successor (ie, the deleted node was not the end),
